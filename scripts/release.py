...
AUTHOR_MAP = {
    "fernandocorreia316@gmail.com": "FACorreiaa",  # fork maintainer (LuminaVault); upstream AUTHOR_MAP has no entry, so contributor-check fails on every PR without this
